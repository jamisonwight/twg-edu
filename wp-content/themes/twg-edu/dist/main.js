...
if (navigator.userAgent.match(/Macintosh/) || navigator.userAgent.match(/(iPhone|iPod|iPad)/i)) {
  document.querySelectorAll('.heading-1, .heading-2, .heading-3, .heading-4, .heading-5, .btn-default, .btn, .section-title').forEach(function (obj, index) {
...
menuHasChildren.forEach(function (obj, index) {
